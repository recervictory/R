annotate_seurat_cluster <- function(seurat_object, cluster_list, other_clusters_name = "Malignant", meta.data_colname = "seurat_clusters_labeled") {
  # Initialize a vector for storing cluster assignments
  cluster_assignments <- rep(other_clusters_name, ncol(seurat_object)) # Default to "Malignant"
